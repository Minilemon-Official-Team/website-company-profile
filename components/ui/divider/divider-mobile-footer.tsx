...
export default function DividerMobileFooter() {
  ...
  return (
    <div className="rotate-360 absolute top-0 z-10 -mt-4 w-full overflow-hidden">
      <svg
      ...
      >
        ...
        <rect width="100%" height="20" fill="url(#divider-mobile-footer)" />
      </svg>
    </div>
  );
}
