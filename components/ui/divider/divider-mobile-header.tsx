...
export default function DividerMobileHeader() {
  ...
  return (
    <div className="absolute bottom-0 z-10 -mb-4 w-full rotate-180 overflow-hidden">
      <svg
      ...
      >
        ...
        <rect width="100%" height="20" fill="url(#divider-mobile-header)" />
      </svg>
    </div>
  );
}
