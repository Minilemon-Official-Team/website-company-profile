  ...
  return (
    <div
      className={cn(
        ...
        scrollPercent >= 100
          ? "rotate-360 absolute top-0 z-10 -mt-4"
          : "absolute bottom-0 z-10 -mb-4 rotate-180",
      )}
    >
      <svg
        ...
        <defs>
          ...
          >
            <path
              ...
              fill={scrollPercent >= 100 ? "#121212" : "#343434"}
            ></path>
          </pattern>
        </defs>
        <rect width="100%" height="20" fill="url(#transparant)" />
      </svg>
    </div>
  );
}
