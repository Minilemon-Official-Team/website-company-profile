          ...
          <div className="z-20 mx-auto flex max-w-screen-640 flex-col justify-center gap-4 px-6">
            ...
            <div className="z-20 mb-3 flex flex-col leading-[1.6rem] tracking-wider sm:leading-7">
              <p className="text-sm leading-[1.6rem] tracking-wider text-[#d3dcf3] sm:leading-7">
                ...
                memproduksi banyak varian produk digital maupun konvensional,
                agar nilai-nilai edukasi dan karakter positif, dapat menjangkau
                ke banyak penggemar khususnya anak-anak usia 3 sampai 7 tahun.
              </p>
            </div>
          </div>
        </div>
              ...
              <motion.div className="mx-auto max-w-screen-640 px-6">
                <motion.div className="container flex flex-col items-center justify-center gap-4">
                  ...
                  <motion.div className="flex flex-col gap-y-8 text-sm leading-[1.6rem] tracking-[.07em] text-[#1b1b1d]/80 sm:leading-7">
                    ...
                    <motion.p variants={paragraphVariants}>
                      Dengan menyadari betapa pentingnya menjaga dan
                      melestarikan alam, Minilemon yang di pimpin oleh Kak Bibie
                      memulai petualangan seru melalui serial animasi pramuka.
                      Dalam petualangan ini, mereka tidak hanya belajar lebih
                      dalam tentang ekosistem yang rumit, keanekaragaman hayati
                      yang menakjubkan, dan pentingnya konservasi alam, tetapi
                      juga menanamkan nilai-nilai positif dan tanggung jawab
                    ...
                    <AnimatePresence>
                      {isExpanded3 && (
                        ...
                        >
                          ...
                          <motion.p variants={paragraphVariants}>
                            Lorem ipsum dolor sit, amet consectetur adipisicing
                            elit. Explicabo officia odit deserunt optio
                            provident consequatur tempora impedit numquam
                            voluptatibus incidunt natus accusantium dignissimos,
                            cupiditate praesentium voluptas, debitis voluptatum
                            velit! Quasi!{" "}
                            <span
                              onClick={toggleExpand3}
                              className="inline-flex cursor-pointer items-center font-bold uppercase text-blue-600 hover:underline"
              ...
              <motion.div className="mx-auto max-w-screen-640 px-6">
                <motion.div className="container flex flex-col items-center justify-center gap-4">
                  ...
                  <motion.div className="flex flex-col gap-y-8 text-sm leading-[1.6rem] tracking-[.07em] text-[#1b1b1d]/70 sm:leading-7">
                    ...
                    <motion.p variants={paragraphVariants}>
                      Minilemon percaya bahwa pendidikan karakter anak tidak
                      hanya mengandalkan tontonan edukasi saja, akan tetapi
                      dibutuhkan juga peran aktif orang tua dalam membimbing
                      anak-anak mereka.
                    </motion.p>
                    <motion.p variants={paragraphVariants}>
                      &quot;Sahabat Minilemon Parenting&quot; adalah program
                      yang dirancang khusus untuk membantu para bunda dengan
                      memberikan tips dan saran praktis yang dapat langsung
                      diterapkan di rumah. Sehingga orang tua dapat ikut
                      berperan mendidik anak-anak mereka.{" "}
                      <Link
                        className="inline-flex items-center font-bold uppercase text-blue-600 hover:underline"
                        href="javascript:void(0)"
                      ...
                      {isExpanded4 && (
                        ...
                        >
                          ...
                          <motion.p variants={paragraphVariants}>
                            ...
                            setiap hari Senin, Rabu, dan Jumat, pukul 16.00 WIB
                            di platform YouTube, TikTok, dan Instagram.
                          </motion.p>
                          <motion.p variants={paragraphVariants}>
                            Lorem ipsum dolor sit, amet consectetur adipisicing
                            elit. Explicabo officia odit deserunt optio
                ...
                <motion.div className="container flex flex-col items-center justify-center gap-4">
                  ...
                  <motion.div className="flex flex-col gap-y-6 text-sm leading-[1.6rem] tracking-[.07em] text-[#1b1b1d]/70 sm:leading-7">
                    ...
                    <motion.p variants={paragraphVariants}>
                      ...
                      &quot;Panggung Boneka Minilemon&quot; selalu disertai
                      dengan pesan-pesan moral yang positif. Melalui karakter
                      Minilemon, anak-anak diajak untuk bermain dan belajar
                      tentang nilai-nilai persahabatan, gotong royong,
